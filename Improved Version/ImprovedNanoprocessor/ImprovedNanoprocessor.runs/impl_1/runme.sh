...
HD_PWD='C:/Users/dinur/ProjectImproved/Project/ImprovedNanoprocessor/ImprovedNanoprocessor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ImprovedNanoprocessor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ImprovedNanoprocessor.tcl -notrace
