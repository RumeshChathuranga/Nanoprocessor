...
HD_PWD='C:/Users/dinur/ProjectImproved/Project/ImprovedNanoprocessor/ImprovedNanoprocessor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ImprovedNanoprocessor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ImprovedNanoprocessor.tcl
